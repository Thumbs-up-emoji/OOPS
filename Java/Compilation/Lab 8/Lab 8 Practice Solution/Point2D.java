...
public class Point2D implements Comparable      // Now, the class will have to provide the definition for the methods in the interface
{
    ...
    // Returns 1 if both the points are equal and 0 otherwise. Note that the method definition is totally decided by the class and that the interface only tells the class to define the method
    {
